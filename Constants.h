...
static const int DIGITS_AND_LETTERS_LENGTH = DIGITS_LENGTH + LETTERS_LENGTH;
static const int LETTRS_AND_SYMBOLS_LENGTH = LETTERS_LENGTH + SYMBOLS_LENGTH;
static const int DIGITS_AND_SYMBOLS_LENGTH = DIGITS_LENGTH + SYMBOLS_LENGTH;
static const int DIGITS_AND_LETTERS_AND_SYMBOLS_LENGTH = DIGITS_LENGTH + SYMBOLS_LENGTH + LETTERS_LENGTH;
